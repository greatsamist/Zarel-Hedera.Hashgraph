...
async function main() {
  ...
  const bytecode = fs.readFileSync(
    "./Contracts/bin/Contracts_ZarelTokenHTS_sol_ZarelToken.bin"
  );
  console.log(`- Done \n`);
...
// async function main() {
//   const samp = AccountId.fromString(process.env.TREASURY_ID);
//   // const samp = ;
//   console.log(samp.toSolidityAddress());
// }
// main();
